...
The result includes: - `text`: your original text - `.error` and `.error_msg`: error tracking - `V1` to `V768`: the embedding dimensions
...
> **TIP**: Check your organisation's tier on OpenAI, tier 5 organisations can send many more requests than tier 1. [OpenAI Rate Limits](https://platform.openai.com/settings/organization/limits)
