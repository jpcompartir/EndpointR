...
We'll need some data, so we'll grab the same sentences and data frame from the [introductory vignette](hugging_face_inference.html) on Hugging Face Inference:
