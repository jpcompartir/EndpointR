...
```{r, eval = TRUE}
batch_concurrent_benchmark <- read.csv(here::here("dev_docs/batch_concurrent_benchmark.csv")) |>
  tibble()
...
> **TIP**: this section of the vignette will assume familiarity with the section on embeddings, i.e. it's expected that you know what a Hugging Face Inference Endpoint is.
