...
-   [ ] Tidy Function (unncessary tibble creation)
-   [ ] Batch Function (large memory footprint, partly due to the tidy func, but also due to the size of the responses (1536 dims of fairly large FP values..))
