...
-   [ ] Completions API Requests & Responses
...
-   [ ] Base Requests
    -   [ ] Single Req
    -   [ ] List of Reqs (can't send batches like we can with HF Inf)
    -   [ ] Data Frame of Reqs
-   [ ] Responses
-   [ ] Structured Outputs
-   [ ] JSON Schema
-   [ ] S7 Objects (Like Pydantic)
