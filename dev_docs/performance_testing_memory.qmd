...
7.  There was quadratic scaling in a match call
...
4.  If there's a schema, dump the schema once. Then build the requests for the batch with the system prompt + schema, then each individual input
